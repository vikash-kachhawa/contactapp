<?php
	...
	$fname = mysqli_real_escape_string($con, clean_input($_POST["group-filter-name"]));
    ...
    if(isset($_POST))
	{
		...
		else
		{
			...
			$sqlchecknameexist = "select * from group_type where name = '".$fname."'";
          	...
          	{
				$sqladdfilter = "insert into group_type (name) values ('".$fname."')";
