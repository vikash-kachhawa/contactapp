<?php
	...
	$fname = mysqli_real_escape_string($con, clean_input($_POST["category-filter-name"]));
    ...
    if(isset($_POST))
	{
		...
		else
		{
			...
			$sqlchecknameexist = "select * from category_type where name = '".$fname."'";
          	...
          	{
				$sqladdfilter = "insert into category_type (name) values ('".$fname."')";
