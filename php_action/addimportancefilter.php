<?php
	...
	$fname = mysqli_real_escape_string($con, clean_input($_POST["importance-filter-name"]));
    ...
    if(isset($_POST))
	{
		...
		else
		{
			...
			$sqlchecknameexist = "select * from importance_type where name = '".$fname."'";
          	...
          	{
				$sqladdfilter = "insert into importance_type (name) values ('".$fname."')";
