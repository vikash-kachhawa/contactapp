<?php
	...
	$fname = mysqli_real_escape_string($con, clean_input($_POST["product-type-filter-name"]));
    ...
    if(isset($_POST))
	{
		...
		else
		{
			...
			$sqlchecknameexist = "select * from product_type where name = '".$fname."'";
          	...
          	{
				$sqladdfilter = "insert into product_type (name) values ('".$fname."')";
